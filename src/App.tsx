...
export default function App() {
  ...
  // Authentication state (default true for instant preview)
  const [isAuthenticated, setIsAuthenticated] = useState<boolean>(() => {
    try {
      const savedAuth = localStorage.getItem('realm_is_authenticated');
  ...
  const handleSignIn = (_email: string) => {
    ...
    showToast(`Welcome back, ${userProfile.name}! Signed into Room B-004 console.`);
  };
