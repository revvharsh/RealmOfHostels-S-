...
import { Sun, Moon, PanelLeft, Crown, GraduationCap, LogOut } from 'lucide-react';
        ...
        {onSignOut && (
          <button
            ...
            className={`p-2 rounded-lg border transition-all cursor-pointer ${
              darkMode
                ? 'border-[#382e25] bg-[#1a1613] hover:border-rose-500/60 text-[#a39e93] hover:text-rose-400'
                : 'border-[#dfd3c3] bg-white hover:border-rose-300 text-stone-600 hover:text-rose-700 shadow-xs'
            }`}
          >
            <LogOut size={16} />
          </button>
